...
From: https://github.com/outlines-dev/outlines/blob/main/examples/vllm_integration.py
Note that the signature is adapted such that the LogitProcessor form vLLM can be easily extended
"""
import json
import math
